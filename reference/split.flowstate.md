...
#>                              <char>    <char>   <char>                  <char>
#> 1: COVAIL_002_CYTOKINE_BLOCK1_1.fcs    Medium Cytekbio 21-JUL-2026 20:56:41.44
...
#>                                $FIL $FLOWRATE    $INST          $LAST_MODIFIED
#>                              <char>    <char>   <char>                  <char>
#> 1: COVAIL_002_CYTOKINE_BLOCK1_2.fcs    Medium Cytekbio 21-JUL-2026 20:56:41.50
#>      $LAST_MODIFIER         $OP $ORIGINALITY   $PAR
#>              <char>      <char>       <char> <char>
#> 1: flowstate_0.17.1 aurora user DataModified     43
#>                             $PROJ $TIMESTEP   $TOT   $VOL APPLY COMPENSATION
...
#>                                $FIL $FLOWRATE    $INST          $LAST_MODIFIED
#>                              <char>    <char>   <char>                  <char>
#> 1: COVAIL_002_CYTOKINE_BLOCK1_3.fcs    Medium Cytekbio 21-JUL-2026 20:56:41.56
#>      $LAST_MODIFIER         $OP $ORIGINALITY   $PAR
#>              <char>      <char>       <char> <char>
#> 1: flowstate_0.17.1 aurora user DataModified     43
#>                             $PROJ $TIMESTEP   $TOT   $VOL APPLY COMPENSATION
