...
[Flow Cytometry Standard](https://pmc.ncbi.nlm.nih.gov/articles/PMC2892967/ "FCS 3.1") files are read and parsed into a `flowstate` (S3 object). A `flowstate` is primarily comprised of the following parsed (named list) elements:
