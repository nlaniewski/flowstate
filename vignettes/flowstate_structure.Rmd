...
`[['parameters']]` also contains attribute-level metadata -- notably, a `parameters.diff` attribute (list) that serves the purpose of preserving sample-specific differences due to unique measurement values (e.g., differences in measured 'Time').
